...
var options = {
    chart: {height: 80, type: "area", sparkline: {enabled: !0}, group: "sparklines"},
    dataLabels: {enabled: !1},
    stroke: {width: 3, curve: "smooth"},
    fill: {type: "gradient", gradient: {shadeIntensity: 1, opacityFrom: .5, opacityTo: 0}},
...
options = {
    chart: {height: 200, type: "line", sparkline: {enabled: !0}, stacked: !1},
    stroke: {width: [2, 3], curve: "smooth", dashArray: [0, 5]},
    plotOptions: {bar: {columnWidth: "50%"}},
    colors: ["#827af3", "#827af3"],
    series: [{name: "Vine", type: "area", data: [44, 55, 41, 67, 22, 43, 21, 41, 56, 27, 43]}, {
        name: "Dribbble",
        type: "line",
    ...
    legend: {
        labels: {useSeriesColors: !0}, markers: {
            customHTML: [function () {
                return ""
            }, function () {
                return ""
...
options = {
    chart: {height: 400, type: "bar", sparkline: {show: !1}, toolbar: {show: !1}},
    colors: ["#827af3", "#fbc647"],
    plotOptions: {bar: {horizontal: !1, columnWidth: "30%", endingShape: "rounded"}},
    dataLabels: {enabled: !1},
    stroke: {show: !1, width: 5, colors: ["#ffffff"]},
    series: [{name: "Mobile", enabled: "true", data: [44, 90, 90, 60, 115]}, {
        name: "Desktop",
...
var lastDate = 0, data = [], TICKINTERVAL = 864e5;
let XAXISRANGE = 7776e5;

function getDayWiseTimeSeries(e, t, a) {
    for (var n = 0; n < t;) {
        var o = e, r = Math.floor(Math.random() * (a.max - a.min + 1)) + a.min;
        data.push({x: o, y: r}), lastDate = e, e += TICKINTERVAL, n++
    }
}
...
(jQuery("#wave-chart-7").length || jQuery("#wave-chart-8").length) && window.setInterval(function () {
    getNewSeries(lastDate, {
        min: 10,
        max: 90
    }), jQuery("#wave-chart-7").length && wave_chart_7.updateSeries([{data: data}]), jQuery("#wave-chart-8").length && wave_chart_8.updateSeries([{data: data}])
}, 1e3);
options = {
    chart: {
        height: 112,
...
if (jQuery("#chart-9").length) {
    ...
    chart9.render(), window.setInterval(function () {
        getNewSeries(lastDate, {min: 10, max: 90}), jQuery("#chart-9").length && chart9.updateSeries([{data: data}])
    }, 1e3)
}

function generateData(e, t, a) {
    for (var n = 0, o = []; n < t;) {
        var r = Math.floor(750 * Math.random()) + 1, i = Math.floor(Math.random() * (a.max - a.min + 1)) + a.min,
...
options = {
    ...
    series: [{
        name: "Bubble1",
        data: generateData(new Date("11 Feb 2017 GMT").getTime(), 10, {min: 10, max: 60})
    }, {
        name: "Bubble2",
        data: generateData(new Date("11 Feb 2017 GMT").getTime(), 10, {min: 10, max: 60})
    }, {
        name: "Bubble3",
        data: generateData(new Date("11 Feb 2017 GMT").getTime(), 10, {min: 10, max: 60})
    }, {name: "Bubble4", data: generateData(new Date("11 Feb 2017 GMT").getTime(), 10, {min: 10, max: 60})}],
    fill: {opacity: .8},
    title: {show: !1},
    xaxis: {tickAmount: 8, type: "category", labels: {show: !1}},
    yaxis: {max: 70, labels: {show: !1}},
    legend: {show: !1}
};
...
var chart11 = {
    chart: {height: 407, type: "line", zoom: {enabled: !1}, toolbar: {show: !1}},
    dataLabels: {enabled: !1},
...
var options12 = {
    chart: {height: 140, type: "area", sparkline: {enabled: !0}, group: "sparklines"},
    dataLabels: {enabled: !1},
...
var chart12, barOptions12 = {
    chart: {height: 150, type: "bar", sparkline: {enabled: !0}, group: "sparklines"},
    dataLabels: {enabled: !1},
    stroke: {curve: "smooth", width: 15},
    series: [{name: "series1", data: [70, 40, 60, 30, 60]}],
    colors: ["#6ce6f4"],
    xaxis: {
        type: "datetime",
...
jQuery("#bar-chart-12").length && ((chart12 = new ApexCharts(document.querySelector("#bar-chart-12"), barOptions12)).render(), window.setInterval(function () {
    getNewSeries(lastDate, {min: 10, max: 90}), jQuery("#bar-chart-12").length && chart12.updateSeries([{data: data}])
}, 1e3));
var option13 = {
    chart: {
        height: 420,
        type: "radialBar",
        stroke: {show: !0, curve: "smooth", lineCap: "butt", colors: void 0, width: 3, dashArray: 0}
    },
    plotOptions: {
        radialBar: {
            hollow: {
...
var option15 = {
    chart: {height: 310, type: "line", stacked: !1, toolbar: {show: !1}},
    dataLabels: {enabled: !1},
    colors: ["#827af3", "#27b345", "#b47af3"],
    series: [{name: "Income", type: "column", data: [14, 2, 25, 15, 25, 28, 38, 46]}, {
        name: "Cashflow",
        type: "column",
        data: [11, 3, 31, 4, 41, 49, 65, 85]
    }, {name: "Revenue", type: "line", data: [20, 29, 37, 36, 44, 45, 50, 58]}],
    stroke: {width: [1, 1, 4]},
    xaxis: {categories: [2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016], labels: {show: !1}},
    yaxis: {show: !1},
    tooltip: {theme: "dark", fixed: {enabled: !0, position: "topLeft", offsetY: 30, offsetX: 60}},
    legend: {show: !1}
};
...
var option16 = {
    chart: {height: 350, type: "area", sparkline: {enabled: !0}, group: "sparklines"},
    dataLabels: {enabled: !1},
    stroke: {curve: "smooth"},
    series: [{name: "series1", data: [3, 30, 15, 25, 35]}],
    colors: ["#6f32ff"],
    xaxis: {
        type: "datetime",
        categories: ["2018-08-19T00:00:00", "2018-09-19T01:30:00", "2018-10-19T02:30:00", "2018-11-19T01:30:00", "2018-12-19T01:30:00"]
...
var option17 = {
    ...
    colors: ["#827af3", "#b47af3", "#27b345"],
    dataLabels: {enabled: !1},
    stroke: {width: [3, 2, 3], curve: "straight"},
    series: [{name: "Session Duration", data: [45, 52, 38, 24, 33, 26, 21, 20, 6, 8, 15, 10]}, {
        name: "Page Views",
        data: [35, 41, 62, 42, 13, 18, 29, 37, 36, 51, 32, 35]
    }, {name: "Total Visits", data: [87, 57, 74, 30, 75, 38, 62, 47, 82, 56, 45, 47]}],
    legend: {show: !1},
    markers: {size: 0, hover: {sizeOffset: 6}},
    xaxis: {
...
var option19 = {
    chart: {height: 308, type: "line", toolbar: {show: !1}},
    series: [{
        name: "Website Blog",
        type: "column",
    ...
    xaxis: {labels: {show: !1}, type: "datetime"},
    yaxis: [{labels: {show: !1}}, {labels: {show: !1}}]
};
...
var option20 = {
    ...
    labels: ["01/01/2003", "02/01/2003", "03/01/2003", "04/01/2003", "05/01/2003", "06/01/2003", "07/01/2003", "08/01/2003", "09/01/2003", "10/01/2003", "11/01/2003"],
    xaxis: {type: "datetime", labels: {show: !1}},
...
if (jQuery("#chartdiv").length && jQuery(document).ready(function () {
    am4core.ready(function () {
        ...
        var e = {
            ...
            AF: {country: "Afghanistan", continent_code: "AS", continent: "Asia", maps: []},
            AG: {
            ...
            BS: {country: "Bahamas", continent_code: "NA", continent: "North America", maps: []},
            ...
            CC: {country: "Cocos (Keeling) Islands", continent_code: "AS", continent: "Asia", maps: []},
            CD: {
            ...
            CI: {country: "Cote d'Ivoire", continent_code: "AF", continent: "Africa", maps: []},
            ...
            CU: {country: "Cuba", continent_code: "NA", continent: "North America", maps: []},
            CV: {
                country: "Cape Verde",
                continent_code: "AF",
                continent: "Africa",
            ...
            ER: {country: "Eritrea", continent_code: "AF", continent: "Africa", maps: []},
            ES: {
                country: "Spain",
                continent_code: "EU",
                continent: "Europe",
            ...
            ET: {country: "Ethiopia", continent_code: "AF", continent: "Africa", maps: []},
            ...
            FK: {country: "Falkland Islands (Malvinas)", continent_code: "SA", continent: "South America", maps: []},
            ...
            GD: {country: "Grenada", continent_code: "NA", continent: "North America", maps: []},
            GE: {
                country: "Georgia",
                continent_code: "EU",
                continent: "Europe",
            ...
            GH: {country: "Ghana", continent_code: "AF", continent: "Africa", maps: []},
            ...
            GM: {country: "Gambia", continent_code: "AF", continent: "Africa", maps: []},
            GN: {country: "Guinea", continent_code: "AF", continent: "Africa", maps: ["guineaLow", "guineaHigh"]},
            GP: {country: "Guadeloupe", continent_code: "NA", continent: "North America", maps: []},
            GQ: {
            ...
            GT: {country: "Guatemala", continent_code: "NA", continent: "North America", maps: []},
            GU: {country: "Guam", continent_code: "OC", continent: "Oceania", maps: []},
            GW: {country: "Guinea-Bissau", continent_code: "AF", continent: "Africa", maps: []},
            GY: {country: "Guyana", continent_code: "SA", continent: "South America", maps: []},
            ...
            HT: {country: "Haiti", continent_code: "NA", continent: "North America", maps: []},
            ...
            IN: {country: "India", continent_code: "AS", continent: "Asia", maps: ["indiaLow", "indiaHigh"]},
            IO: {country: "British Indian Ocean Territory", continent_code: "AS", continent: "Asia", maps: []},
            IQ: {country: "Iraq", continent_code: "AS", continent: "Asia", maps: []},
            IR: {country: "Iran, Islamic Republic of", continent_code: "AS", continent: "Asia", maps: []},
            IS: {country: "Iceland", continent_code: "EU", continent: "Europe", maps: ["icelandLow", "icelandHigh"]},
            IT: {country: "Italy", continent_code: "EU", continent: "Europe", maps: ["italyLow", "italyHigh"]},
            JE: {country: "Jersey", continent_code: "EU", continent: "Europe", maps: []},
            JM: {country: "Jamaica", continent_code: "NA", continent: "North America", maps: []},
            JO: {country: "Jordan", continent_code: "AS", continent: "Asia", maps: []},
            ...
            KM: {country: "Comoros", continent_code: "AF", continent: "Africa", maps: []},
            KN: {country: "Saint Kitts and Nevis", continent_code: "NA", continent: "North America", maps: []},
            KP: {
            ...
            KW: {country: "Kuwait", continent_code: "AS", continent: "Asia", maps: []},
            KY: {country: "Cayman Islands", continent_code: "NA", continent: "North America", maps: []},
            KZ: {
                country: "Kazakhstan",
                continent_code: "EU",
                continent: "Europe",
            ...
            LA: {country: "Lao People's Democratic Republic", continent_code: "AS", continent: "Asia", maps: []},
            LB: {country: "Lebanon", continent_code: "AS", continent: "Asia", maps: []},
            LC: {
                country: "Saint Lucia",
                continent_code: "NA",
                continent: "North America",
            ...
            LR: {country: "Liberia", continent_code: "AF", continent: "Africa", maps: []},
            LS: {country: "Lesotho", continent_code: "AF", continent: "Africa", maps: []},
            LT: {
                country: "Lithuania",
                continent_code: "EU",
                continent: "Europe",
            ...
            LU: {country: "Luxembourg", continent_code: "EU", continent: "Europe", maps: []},
            LV: {country: "Latvia", continent_code: "EU", continent: "Europe", maps: ["latviaLow", "latviaHigh"]},
            LY: {country: "Libya", continent_code: "AF", continent: "Africa", maps: []},
            ...
            ME: {country: "Montenegro", continent_code: "EU", continent: "Europe", maps: []},
            MF: {country: "Saint Martin (French Part)", continent_code: "NA", continent: "North America", maps: []},
            MG: {country: "Madagascar", continent_code: "AF", continent: "Africa", maps: []},
            MH: {country: "Marshall Islands", continent_code: "OC", continent: "Oceania", maps: []},
            MK: {country: "North Macedonia", continent_code: "EU", continent: "Europe", maps: []},
            ML: {country: "Mali", continent_code: "AF", continent: "Africa", maps: ["maliLow", "maliHigh"]},
            MM: {country: "Myanmar", continent_code: "AS", continent: "Asia", maps: []},
            ...
            MP: {country: "Northern Mariana Islands", continent_code: "OC", continent: "Oceania", maps: []},
            MQ: {country: "Martinique", continent_code: "NA", continent: "North America", maps: []},
            MR: {country: "Mauritania", continent_code: "AF", continent: "Africa", maps: []},
            MS: {country: "Montserrat", continent_code: "NA", continent: "North America", maps: []},
            ...
            MW: {country: "Malawi", continent_code: "AF", continent: "Africa", maps: []},
            MX: {
                country: "Mexico",
                continent_code: "NA",
                continent: "North America",
            ...
            MZ: {country: "Mozambique", continent_code: "AF", continent: "Africa", maps: []},
            ...
            NE: {country: "Niger", continent_code: "AF", continent: "Africa", maps: []},
            ...
            NO: {country: "Norway", continent_code: "EU", continent: "Europe", maps: ["norwayLow", "norwayHigh"]},
            ...
            RW: {country: "Rwanda", continent_code: "AF", continent: "Africa", maps: []},
            SA: {
            ...
            SL: {country: "Sierra Leone", continent_code: "AF", continent: "Africa", maps: []},
            SM: {
                country: "San Marino",
                continent_code: "EU",
                continent: "Europe",
            ...
            SR: {country: "Suriname", continent_code: "SA", continent: "South America", maps: []},
            SS: {country: "South Sudan", continent_code: "AF", continent: "Africa", maps: []},
            ST: {
            ...
            TG: {country: "Togo", continent_code: "AF", continent: "Africa", maps: []},
            ...
            TL: {country: "Timor-Leste", continent_code: "AS", continent: "Asia", maps: []},
            TM: {country: "Turkmenistan", continent_code: "AS", continent: "Asia", maps: []},
            ...
            TT: {country: "Trinidad and Tobago", continent_code: "NA", continent: "North America", maps: []},
            TV: {country: "Tuvalu", continent_code: "OC", continent: "Oceania", maps: []},
            TW: {country: "Taiwan, Province of China", continent_code: "AS", continent: "Asia", maps: []},
            TZ: {
            ...
            UG: {country: "Uganda", continent_code: "AF", continent: "Africa", maps: []},
            ...
            UY: {country: "Uruguay", continent_code: "SA", continent: "South America", maps: []},
            UZ: {
                country: "Uzbekistan",
                continent_code: "AS",
                continent: "Asia",
            ...
            VG: {country: "Virgin Islands, British", continent_code: "NA", continent: "North America", maps: []},
            VI: {country: "Virgin Islands, U.S.", continent_code: "NA", continent: "North America", maps: []},
        ...
        }, t = {AF: 0, AN: 1, AS: 2, EU: 3, NA: 4, OC: 5, SA: 6}, a = am4core.create("chartdiv", am4maps.MapChart);
        ...
        for (var s in e) if (e.hasOwnProperty(s)) {
            var l = e[s];
            l.maps.length && c.push({id: s, color: a.colors.getIndex(t[l.continent_code]), map: l.maps[0]})
        }
    ...
    new FullCalendar.Calendar(e, {plugins: ["dayGrid"]}).render()
    ...
    new FullCalendar.Calendar(e, {
        ...
        events: [{title: "All Day Event", start: "2019-12-01", color: "#fc9919"}, {
            title: "Long Event",
            start: "2019-12-07",
            end: "2019-12-10",
            color: "#ffc107"
            ...
            url: "http://google.com/",
            start: "2019-12-28"
        }, {title: "Meeting", start: "2020-01-12T14:30:00", color: "#827af3"}, {
...
if (jQuery("#apex-bar").length) {
    options = {
        ...
        dataLabels: {enabled: !1},
        colors: ["#827af3"],
        series: [{data: [470, 540, 580, 690, 1100, 1200, 1380]}],
        xaxis: {categories: ["Netherlands", "Italy", "France", "Japan", "United States", "China", "Germany"]}
    };
...
if (jQuery("#apex-mixed-chart").length) {
    options = {
        ...
        series: [{name: "Facebook", type: "column", data: [23, 11, 22, 27, 13, 22, 37, 21, 44, 22, 30]}, {
            name: "Vine",
            type: "area",
...
if (jQuery("#apex-bubble-chart").length) {
    function generateData(e, t, a) {
        for (var n = 0, o = []; n < t;) {
            var r = Math.floor(Math.random() * (a.max - a.min + 1)) + a.min, i = Math.floor(61 * Math.random()) + 15;
    ...
    options = {
        ...
        series: [{
            ...
            name: "Product2",
            data: generateData(new Date("11 Feb 2017 GMT").getTime(), 20, {min: 10, max: 40})
        }, {name: "Product3", data: generateData(new Date("11 Feb 2017 GMT").getTime(), 20, {min: 10, max: 40})}],
        fill: {type: "gradient"},
        colors: ["#827af3", "#27b345", "#b47af3"],
...
if (jQuery("#apex-scatter-chart").length) {
    options = {
        ...
        series: [{
            name: "SAMPLE A",
            data: [[16.4, 5.4], [21.7, 2], [10.9, 0], [10.9, 8.2], [16.4, 0], [16.4, 1.8], [13.6, .3], [13.6, 0], [29.9, 0], [27.1, 2.3], [16.4, 0], [13.6, 3.7], [10.9, 5.2], [16.4, 6.5], [10.9, 0], [24.5, 7.1], [10.9, 0], [8.1, 4.7]]
        }, {
            name: "SAMPLE B",
            data: [[36.4, 13.4], [1.7, 11], [1.9, 9], [1.9, 13.2], [1.4, 7], [6.4, 8.8], [3.6, 4.3], [1.6, 10], [9.9, 2], [7.1, 15], [1.4, 0], [3.6, 13.7], [1.9, 15.2], [6.4, 16.5], [.9, 10], [4.5, 17.1], [10.9, 10], [.1, 14.7]]
        }, {
            name: "SAMPLE C",
            data: [[21.7, 3], [23.6, 3.5], [28, 4], [27.1, .3], [16.4, 4], [13.6, 0], [19, 5], [22.4, 3], [24.5, 3], [32.6, 3], [27.1, 4], [29.6, 6], [31.6, 8], [21.6, 5], [20.9, 4], [22.4, 0], [32.6, 10.3], [29.7, 20.8]]
        }],
        xaxis: {
            tickAmount: 5, labels: {
                formatter: function (e) {
...
if (jQuery("#apex-area-02").length) {
    options = {
        ...
        chart: {height: 350, type: "radar", dropShadow: {enabled: !0, blur: 1, left: 1, top: 1}},
...
if (jQuery("#am-simple-chart").length && am4core.ready(function () {
    ...
    e.colors.list = [am4core.color("#827af3")], e.data = [{country: "USA", visits: 2025}, {
        country: "China",
        visits: 1882
    }, {country: "Japan", visits: 1809}, {country: "UK", visits: 1122}, {country: "France", visits: 1114}];
    ...
    r.radius = 4, r.fill = am4core.color("#fff"), r.strokeWidth = 3, e.data = [{
        ...
        income: 23.5,
        expenses: 21.1
    }, {year: "2010", income: 26.2, expenses: 30.5}, {year: "2011", income: 30.1, expenses: 34.9}, {
        year: "2012",
        income: 29.5,
        expenses: 31.1
    ...
    e.colors.list = [am4core.color("#827af3"), am4core.color("#b47af3"), am4core.color("#27b345")], e.data = [{
        ...
        lamerica: .3,
        meast: .2
    }, {year: "2018", europe: 2.8, namerica: 2.9, asia: 2.4, lamerica: .3, meast: .3}];
    var t = e.xAxes.push(new am4charts.CategoryAxis);
    ...
    e.colors.list = [am4core.color("#827af3"), am4core.color("#827af3")], e.data = [{
        ...
        income: 23.5,
        expenses: 18.1
    }, {year: "2006", income: 26.2, expenses: 22.8}, {year: "2007", income: 30.1, expenses: 23.9}, {
        year: "2008",
        income: 29.5,
        expenses: 25.1
    ...
    e.colors.list = [am4core.color("#827af3")], e.data = [{date: "2012-07-27", value: 13}, {
        date: "2012-07-28",
        value: 11
    }, {date: "2012-07-29", value: 15}, {date: "2012-07-30", value: 16}, {
        date: "2012-07-31",
        value: 18
    }, {date: "2012-08-01", value: 13}, {date: "2012-08-02", value: 22}, {
        date: "2012-08-03",
        value: 23
    }, {date: "2012-08-04", value: 20}, {date: "2012-08-05", value: 17}, {
        date: "2012-08-06",
        value: 16
    }, {date: "2012-08-07", value: 18}, {date: "2012-08-08", value: 21}, {
        date: "2012-08-09",
        value: 26
    }, {date: "2012-08-10", value: 24}, {date: "2012-08-11", value: 29}, {
        date: "2012-08-12",
        value: 32
    }, {date: "2012-08-13", value: 18}, {date: "2012-08-14", value: 24}, {
        date: "2012-08-15",
        value: 22
    }, {date: "2012-08-16", value: 18}, {date: "2012-08-17", value: 19}, {
        date: "2012-08-18",
        value: 14
    }, {date: "2012-08-19", value: 15}, {date: "2012-08-20", value: 12}, {
        date: "2012-08-21",
        value: 8
    }, {date: "2012-08-22", value: 9}, {date: "2012-08-23", value: 8}, {
        date: "2012-08-24",
        value: 7
    }, {date: "2012-08-25", value: 5}, {date: "2012-08-26", value: 11}, {
        date: "2012-08-27",
        value: 13
    }, {date: "2012-08-28", value: 18}, {date: "2012-08-29", value: 20}, {
        date: "2012-08-30",
        value: 29
    }, {date: "2012-08-31", value: 33}, {date: "2012-09-01", value: 42}, {
        date: "2012-09-02",
        value: 35
    }, {date: "2012-09-03", value: 31}, {date: "2012-09-04", value: 47}, {
        date: "2012-09-05",
        value: 52
    }, {date: "2012-09-06", value: 46}, {date: "2012-09-07", value: 41}, {
        date: "2012-09-08",
        value: 43
    }, {date: "2012-09-09", value: 40}, {date: "2012-09-10", value: 39}, {
        date: "2012-09-11",
        value: 34
    }, {date: "2012-09-12", value: 29}, {date: "2012-09-13", value: 34}, {
        date: "2012-09-14",
        value: 37
    }, {date: "2012-09-15", value: 42}, {date: "2012-09-16", value: 49}, {
        date: "2012-09-17",
        value: 46
    }, {date: "2012-09-18", value: 47}, {date: "2012-09-19", value: 55}, {
        date: "2012-09-20",
        value: 59
    }, {date: "2012-09-21", value: 58}, {date: "2012-09-22", value: 57}, {
        date: "2012-09-23",
        value: 61
    }, {date: "2012-09-24", value: 59}, {date: "2012-09-25", value: 67}, {
        date: "2012-09-26",
        value: 65
    }, {date: "2012-09-27", value: 61}, {date: "2012-09-28", value: 66}, {
        date: "2012-09-29",
        value: 69
    }, {date: "2012-09-30", value: 71}, {date: "2012-10-01", value: 67}, {
        date: "2012-10-02",
        value: 63
    }, {date: "2012-10-03", value: 46}, {date: "2012-10-04", value: 32}, {
        date: "2012-10-05",
        value: 21
    }, {date: "2012-10-06", value: 18}, {date: "2012-10-07", value: 21}, {
        date: "2012-10-08",
        value: 28
    }, {date: "2012-10-09", value: 27}, {date: "2012-10-10", value: 36}, {
        date: "2012-10-11",
        value: 33
    }, {date: "2012-10-12", value: 31}, {date: "2012-10-13", value: 30}, {
        date: "2012-10-14",
        value: 34
    }, {date: "2012-10-15", value: 38}, {date: "2012-10-16", value: 37}, {
        date: "2012-10-17",
        value: 44
    }, {date: "2012-10-18", value: 49}, {date: "2012-10-19", value: 53}, {
        date: "2012-10-20",
        value: 57
    }, {date: "2012-10-21", value: 60}, {date: "2012-10-22", value: 61}, {
        date: "2012-10-23",
        value: 69
    }, {date: "2012-10-24", value: 67}, {date: "2012-10-25", value: 72}, {
        date: "2012-10-26",
        value: 77
    }, {date: "2012-10-27", value: 75}, {date: "2012-10-28", value: 70}, {
        date: "2012-10-29",
        value: 72
    }, {date: "2012-10-30", value: 70}, {date: "2012-10-31", value: 72}, {
        date: "2012-11-01",
        value: 73
    }, {date: "2012-11-02", value: 67}, {date: "2012-11-03", value: 68}, {
        date: "2012-11-04",
        value: 65
    }, {date: "2012-11-05", value: 71}, {date: "2012-11-06", value: 75}, {
        date: "2012-11-07",
        value: 74
    }, {date: "2012-11-08", value: 71}, {date: "2012-11-09", value: 76}, {
        date: "2012-11-10",
        value: 77
    }, {date: "2012-11-11", value: 81}, {date: "2012-11-12", value: 83}, {
        date: "2012-11-13",
        value: 80
    }, {date: "2012-11-14", value: 81}, {date: "2012-11-15", value: 87}, {
        date: "2012-11-16",
        value: 82
    }, {date: "2012-11-17", value: 86}, {date: "2012-11-18", value: 80}, {
        date: "2012-11-19",
        value: 87
    }, {date: "2012-11-20", value: 83}, {date: "2012-11-21", value: 85}, {
        date: "2012-11-22",
        value: 84
    }, {date: "2012-11-23", value: 82}, {date: "2012-11-24", value: 73}, {
        date: "2012-11-25",
        value: 71
    }, {date: "2012-11-26", value: 75}, {date: "2012-11-27", value: 79}, {
        date: "2012-11-28",
        value: 70
    }, {date: "2012-11-29", value: 73}, {date: "2012-11-30", value: 61}, {
        date: "2012-12-01",
        value: 62
    }, {date: "2012-12-02", value: 66}, {date: "2012-12-03", value: 65}, {
        date: "2012-12-04",
        value: 73
    }, {date: "2012-12-05", value: 79}, {date: "2012-12-06", value: 78}, {
        date: "2012-12-07",
        value: 78
    }, {date: "2012-12-08", value: 78}, {date: "2012-12-09", value: 74}, {
        date: "2012-12-10",
        value: 73
    }, {date: "2012-12-11", value: 75}, {date: "2012-12-12", value: 70}, {
        date: "2012-12-13",
        value: 77
    }, {date: "2012-12-14", value: 67}, {date: "2012-12-15", value: 62}, {
        date: "2012-12-16",
        value: 64
    }, {date: "2012-12-17", value: 61}, {date: "2012-12-18", value: 59}, {
        date: "2012-12-19",
        value: 53
    }, {date: "2012-12-20", value: 54}, {date: "2012-12-21", value: 56}, {
        date: "2012-12-22",
        value: 59
    }, {date: "2012-12-23", value: 58}, {date: "2012-12-24", value: 55}, {
        date: "2012-12-25",
        value: 52
    }, {date: "2012-12-26", value: 54}, {date: "2012-12-27", value: 50}, {
        date: "2012-12-28",
        value: 50
    }, {date: "2012-12-29", value: 51}, {date: "2012-12-30", value: 52}, {
        date: "2012-12-31",
        value: 58
    }, {date: "2013-01-01", value: 60}, {date: "2013-01-02", value: 67}, {
        date: "2013-01-03",
        value: 64
    }, {date: "2013-01-04", value: 66}, {date: "2013-01-05", value: 60}, {
        date: "2013-01-06",
        value: 63
    }, {date: "2013-01-07", value: 61}, {date: "2013-01-08", value: 60}, {
        date: "2013-01-09",
        value: 65
    }, {date: "2013-01-10", value: 75}, {date: "2013-01-11", value: 77}, {
        date: "2013-01-12",
        value: 78
    }, {date: "2013-01-13", value: 70}, {date: "2013-01-14", value: 70}, {
        date: "2013-01-15",
        value: 73
    }, {date: "2013-01-16", value: 71}, {date: "2013-01-17", value: 74}, {
        date: "2013-01-18",
        value: 78
    }, {date: "2013-01-19", value: 85}, {date: "2013-01-20", value: 82}, {
        date: "2013-01-21",
        value: 83
    }, {date: "2013-01-22", value: 88}, {date: "2013-01-23", value: 85}, {
        date: "2013-01-24",
        value: 85
    }, {date: "2013-01-25", value: 80}, {date: "2013-01-26", value: 87}, {
        date: "2013-01-27",
        value: 84
    }, {date: "2013-01-28", value: 83}, {date: "2013-01-29", value: 84}, {
        date: "2013-01-30",
        value: 81
    ...
    e.colors.list = [am4core.color("#827af3")], e.data = [{date: "2012-07-27", value: 13}, {
        ...
        date: "2012-11-13",
        value: 80
    }, {date: "2012-11-18", value: 80}, {date: "2012-11-19", value: 87}, {
        date: "2012-11-20",
        value: 83
    }, {date: "2012-11-21", value: 85}, {date: "2012-11-22", value: 84}, {
        date: "2012-11-23",
        value: 82
    }, {date: "2012-11-24", value: 73}, {date: "2012-11-25", value: 71}, {
        date: "2012-11-26",
        value: 75
    }, {date: "2012-11-27", value: 79}, {date: "2012-11-28", value: 70}, {
        date: "2012-11-29",
        value: 73
    }, {date: "2012-11-30", value: 61}, {date: "2012-12-01", value: 62}, {
        date: "2012-12-02",
        value: 66
    }, {date: "2012-12-03", value: 65}, {date: "2012-12-04", value: 73}, {
        date: "2012-12-05",
        value: 79
    }, {date: "2012-12-06", value: 78}, {date: "2012-12-07", value: 78}, {
        date: "2012-12-08",
        value: 78
    }, {date: "2012-12-09", value: 74}, {date: "2012-12-10", value: 73}, {
        date: "2012-12-11",
        value: 75
    }, {date: "2012-12-12", value: 70}, {date: "2012-12-13", value: 77}, {
        date: "2012-12-14",
        value: 67
    }, {date: "2012-12-15", value: 62}, {date: "2012-12-16", value: 64}, {
        date: "2012-12-17",
        value: 61
    }, {date: "2012-12-18", value: 59}, {date: "2012-12-19", value: 53}, {
        date: "2012-12-20",
        value: 54
    }, {date: "2012-12-21", value: 56}, {date: "2012-12-22", value: 59}, {
        date: "2012-12-23",
        value: 58
    }, {date: "2012-12-24", value: 55}, {date: "2012-12-25", value: 52}, {
        date: "2012-12-26",
        value: 54
    }, {date: "2012-12-27", value: 50}, {date: "2012-12-28", value: 50}, {
        date: "2012-12-29",
        value: 51
    }, {date: "2012-12-30", value: 52}, {date: "2012-12-31", value: 58}, {
        date: "2013-01-01",
        value: 60
    }, {date: "2013-01-02", value: 67}, {date: "2013-01-03", value: 64}, {
        date: "2013-01-04",
        value: 66
    }, {date: "2013-01-05", value: 60}, {date: "2013-01-06", value: 63}, {
        date: "2013-01-07",
        value: 61
    }, {date: "2013-01-08", value: 60}, {date: "2013-01-09", value: 65}, {
        date: "2013-01-10",
        value: 75
    }, {date: "2013-01-11", value: 77}, {date: "2013-01-12", value: 78}, {
        date: "2013-01-13",
        value: 70
    }, {date: "2013-01-14", value: 70}, {date: "2013-01-15", value: 73}, {
        date: "2013-01-16",
        value: 71
    }, {date: "2013-01-17", value: 74}, {date: "2013-01-18", value: 78}, {
        date: "2013-01-19",
        value: 85
    }, {date: "2013-01-20", value: 82}, {date: "2013-01-21", value: 83}, {
        date: "2013-01-22",
        value: 88
    }, {date: "2013-01-23", value: 85}, {date: "2013-01-24", value: 85}, {
        date: "2013-01-25",
        value: 80
    }, {date: "2013-01-26", value: 87}, {date: "2013-01-27", value: 84}, {
        date: "2013-01-28",
        value: 83
    }, {date: "2013-01-29", value: 84}, {date: "2013-01-30", value: 81}];
    var t = e.xAxes.push(new am4charts.DateAxis);
    ...
    e.colors.list = [am4core.color("#827af3")], e.data = [{country: "Lithuania", litres: 501}, {
        country: "Czechia",
        litres: 301
    }, {country: "Ireland", litres: 266}, {country: "Germany", litres: 165}, {
        country: "Australia",
        litres: 139
    }, {country: "Austria", litres: 336}, {country: "UK", litres: 290}, {
        country: "Belgium",
        litres: 325
    }, {
    ...
    e.data = [{direction: "N", value: 8}, {direction: "NE", value: 9}, {direction: "E", value: 4.5}, {
        direction: "SE",
        value: 3.5
    }, {direction: "S", value: 9.2}, {direction: "SW", value: 8.4}, {direction: "W", value: 11.1}, {
        direction: "NW",
        value: 10
    }];
    var t = e.xAxes.push(new am4charts.CategoryAxis);
    ...
    a.bullets.push(new am4charts.CircleBullet), a.strokeOpacity = 0, a.dataFields.valueX = "x", a.dataFields.valueY = "y", a.name = "Series #1", a.sequencedInterpolation = !0, a.sequencedInterpolationDelay = 10, a.data = [{
        x: 83,
        y: 5.1
    }, {x: 44, y: 5.8}, {x: 76, y: 9}, {x: 2, y: 1.4}, {x: 100, y: 8.3}, {x: 96, y: 1.7}, {x: 68, y: 3.9}, {
        x: 0,
        y: 3
    }, {x: 100, y: 4.1}, {x: 16, y: 5.5}, {x: 71, y: 6.8}, {x: 100, y: 7.9}, {x: 35, y: 8}, {x: 44, y: 6}, {
        x: 64,
        y: .7
    }, {x: 53, y: 3.3}, {x: 92, y: 4.1}, {x: 43, y: 7.3}, {x: 15, y: 7.5}, {x: 43, y: 4.3}, {x: 90, y: 9.9}];
    ...
    n.bullets.push(new am4charts.CircleBullet), n.strokeOpacity = 0, n.dataFields.valueX = "x", n.dataFields.valueY = "y", n.name = "Series #2", n.sequencedInterpolation = !0, n.sequencedInterpolationDelay = 10, n.data = [{
        x: 178,
        y: 1.3
    }, {x: 129, y: 3.4}, {x: 99, y: 2.4}, {x: 80, y: 9.9}, {x: 118, y: 9.4}, {x: 103, y: 8.7}, {x: 91, y: 4.2}, {
        x: 151,
        y: 1.2
    }, {x: 168, y: 5.2}, {x: 168, y: 1.6}, {x: 152, y: 1.2}, {x: 138, y: 7.7}, {x: 107, y: 3.9}, {
        x: 124,
        y: .7
    }, {x: 130, y: 2.6}, {x: 86, y: 9.2}, {x: 169, y: 7.5}, {x: 122, y: 9.9}, {x: 100, y: 3.8}, {
        x: 172,
        y: 4.1
    }, {x: 140, y: 7.3}, {x: 161, y: 2.3}, {x: 141, y: .9}];
    ...
    o.bullets.push(new am4charts.CircleBullet), o.strokeOpacity = 0, o.dataFields.valueX = "x", o.dataFields.valueY = "y", o.name = "Series #3", o.sequencedInterpolation = !0, o.sequencedInterpolationDelay = 10, o.data = [{
        x: 419,
        y: 4.9
    }, {x: 417, y: 5.5}, {x: 434, y: .1}, {x: 344, y: 2.5}, {x: 279, y: 7.5}, {x: 307, y: 8.4}, {x: 279, y: 9}, {
        x: 220,
        y: 8.4
    }, {x: 201, y: 9.7}, {x: 288, y: 1.2}, {x: 333, y: 7.4}, {x: 308, y: 1.9}, {x: 330, y: 8}, {
        x: 408,
        y: 1.7
    }, {x: 274, y: .8}, {x: 296, y: 3.1}, {x: 279, y: 4.3}, {x: 379, y: 5.6}, {
        x: 175,
        y: 6.8
    ...
    e.hiddenState.properties.opacity = 0, e.legend = new am4charts.Legend, e.data = [{
        country: "Lithuania",
        litres: 501.9
    }, {country: "Germany", litres: 165.8}, {country: "Australia", litres: 139.9}, {
        country: "Austria",
        litres: 128.3
    ...
    data: [{year: "2008", value: 20}, {year: "2009", value: 10}, {year: "2010", value: 5}],
    xkey: "year",
    ykeys: ["value"],
    labels: ["Value"],
    lineColors: ["#827af3"]
    ...
    data: [{x: "2011 Q1", y: 3, z: 2}, {x: "2011 Q2", y: 2, z: null, a: 1}, {
        x: "2011 Q3",
        y: 0,
        z: 2,
        a: 4
    ...
    data: [{y: "2011 Q1", item1: 2666, item2: 2666}, {y: "2011 Q2", item1: 2778, item2: 2294}, {
        ...
        item1: 4912,
        item2: 1969
    }, {y: "2011 Q4", item1: 3767, item2: 3597}, {y: "2012 Q1", item1: 6810, item2: 1914}, {
        y: "2012 Q2",
        item1: 5670,
        item2: 4293
    }],
...
if (jQuery("#morris-donut-chart").length) var donut = new Morris.Donut({
    ...
    resize: !0,
    colors: ["#827af3", "#b47af3", "#27b345"],
    data: [{label: "Download Sales", value: 30}, {label: "In-Store Sales", value: 12}, {
...
if (jQuery("#high-basicline-chart").length && Highcharts.chart("high-basicline-chart", {
    ...
    xAxis: {
        reversed: !1,
        title: {enabled: !0, text: "Altitude"},
        labels: {format: "{value} km"},
        maxPadding: .05,
        showLastLabel: !0
    },
    yAxis: {title: {text: "Temperature"}, labels: {format: "{value}°"}, lineWidth: 2},
    legend: {enabled: !1},
    tooltip: {headerFormat: "<b>{series.name}</b><br/>", pointFormat: "{point.x} km: {point.y}°C"},
    plotOptions: {spline: {marker: {enable: !1}}},
    series: [{
        name: "Temperature",
        color: "#827af3",
    ...
    tooltip: {shared: !0, valueSuffix: " units"},
    credits: {enabled: !1},
    plotOptions: {areaspline: {fillOpacity: .5}},
    series: [{name: "John", color: "#827af3", data: [3, 4, 3, 5, 4, 10, 12]}, {
        name: "Jane",
        color: "#27b345",
        data: [1, 3, 4, 3, 3, 5, 4]
    }]
    ...
    series: [{name: "John", color: "#827af3", data: [5, 3, 4, 7, 2]}, {
        name: "Jane",
        color: "#b47af3",
        data: [2, 2, 3, 2, 1]
    }, {name: "Joe", color: "#27b345", data: [3, 4, 4, 2, 5]}]
    ...
    plotOptions: {
        pie: {
            allowPointSelect: !0,
            cursor: "pointer",
            dataLabels: {enabled: !0, format: "<b>{point.name}</b>: {point.percentage:.1f} %"}
        }
    },
    series: [{
        name: "Brands",
        colorByPoint: !0,
        data: [{name: "Chrome", y: 61.41, sliced: !0, selected: !0, color: "#827af3"}, {
            name: "Internet Explorer",
            y: 11.84,
            color: "#b47af3"
        }, {name: "Firefox", y: 10.85, color: "#c8c8c8"}, {name: "Edge", y: 4.67, color: "#6ce6f4"}, {
            name: "Other",
            y: 2.61
        }]
    }]
    ...
    xAxis: {title: {enabled: !0, text: "Height (cm)"}, startOnTick: !0, endOnTick: !0, showLastLabel: !0},
    ...
    plotOptions: {
        scatter: {
            marker: {radius: 5, states: {hover: {enabled: !0, lineColor: "rgb(100,100,100)"}}},
    ...
    series: [{
        ...
        data: [[161.2, 51.6], [167.5, 59], [159.5, 49.2], [157, 63], [155.8, 53.6], [170, 59], [159.1, 47.6], [166, 69.8], [176.2, 66.8], [160.2, 75.2], [172.7, 62], [155, 49.2], [156.5, 67.2], [164, 53.8], [160.9, 54.4]],
        color: "#827af3"
    }, {
        name: "Male",
        color: "rgba(119, 152, 191, .5)",
        data: [[174, 65.6], [175.3, 71.8], [193.5, 80.7], [186.5, 72.6], [187.2, 78.8], [181.5, 74.8], [184, 86.4], [184.5, 78.4], [175, 62], [184, 81.6], [180.1, 93], [175.5, 80.9], [180.6, 72.7], [184.4, 68], [175.5, 70.9], [180.3, 83.2], [180.3, 83.2]],
        color: "#b47af3"
    }]
    ...
    yAxis: [{
        labels: {format: "{value}°C", style: {color: Highcharts.getOptions().colors[1]}},
        title: {text: "Temperature", style: {color: Highcharts.getOptions().colors[1]}}
    }, {
        title: {text: "Rainfall", style: {color: Highcharts.getOptions().colors[0]}},
        labels: {format: "{value} mm", style: {color: Highcharts.getOptions().colors[0]}},
        opposite: !0
    }],
    tooltip: {shared: !0},
    legend: {
        ...
        events: {
            load: function () {
                ...
                setInterval(function () {
                    var t = (new Date).getTime(), a = Math.random();
                    e.addPoint([t, a], !0, !0)
                }, 1e3)
            }
        }
    ...
    exporting: {enabled: !1},
    series: [{
        name: "Random data", color: "#827af3", data: function () {
            var e, t = [], a = (new Date).getTime();
            for (e = -19; e <= 0; e += 1) t.push({x: a + 1e3 * e, y: Math.random()});
            return t
        }()
    }]
    ...
    var chart = new Highcharts.Chart({
        chart: {
            ...
            type: "column",
            options3d: {enabled: !0, alpha: 15, beta: 15, depth: 50, viewDistance: 25}
        },
        title: {text: "Chart rotation demo"},
        subtitle: {text: "Test options by dragging the sliders below"},
        plotOptions: {column: {depth: 25}},
        series: [{data: [29.9, 71.5, 106.4, 129.2, 144, 176, 135.6, 148.5, 216.4, 194.1, 95.6, 54.4], color: "#827af3"}]
    });
...
if (jQuery("#high-gauges-chart").length && Highcharts.chart("high-gauges-chart", {
    ...
    yAxis: {
        ...
        title: {text: "km/h"},
        plotBands: [{from: 0, to: 120, color: "#55BF3B"}, {from: 120, to: 160, color: "#DDDF0D"}, {
            from: 160,
            to: 200,
            color: "#DF5353"
        }]
    },
    series: [{name: "Speed", data: [80], tooltip: {valueSuffix: " km/h"}}]
}, function (e) {
    e.renderer.forExport || setInterval(function () {
        var t, a = e.series[0].points[0], n = Math.round(20 * (Math.random() - .5));
    ...
    Highcharts.chart("high-barwithnagative-chart", {
        ...
        yAxis: {
            ...
            }, accessibility: {description: "Percentage population", rangeDescription: "Range: 0 to 5%"}
        },
        plotOptions: {series: {stacking: "normal"}},
        tooltip: {
            formatter: function () {
        ...
        series: [{
            ...
            color: "#827af3"
        }, {name: "Female", data: [2.1, 2, 2.1, 2.3, 2.6, 2.9, 3.2, 3.1, 2.9, 3.4, 0], color: "#27b345"}]
    })
}
if (jQuery("#home-chart-01").length) {
    options = {
        series: [{name: "Desktops", data: [5, 10, 8, 15]}],
        chart: {height: 150, type: "line", zoom: {enabled: !1}},
        colors: ["#827af3"],
        dataLabels: {enabled: !1},
        stroke: {curve: "straight"},
        grid: {row: {colors: ["#f3f3f3", "transparent"], opacity: .5}},
...
if (jQuery("#home-chart-03").length) {
    options = {
        series: [44, 55, 13, 33],
        chart: {width: 380, height: 180, type: "donut"},
        dataLabels: {enabled: !1},
        colors: ["#827af3", "#6ce6f4", "#a09e9e", "#fbc647"],
        responsive: [{breakpoint: 480, options: {chart: {width: 200}, legend: {show: !1}}}],
        legend: {position: "right", offsetY: 0, height: 150}
    };
...
jQuery("#home-chart-04").length && am4core.ready(function () {
    ...
    var e = "M9,0C4.029,0,0,4.029,0,9s4.029,9,9,9s9-4.029,9-9S13.971,0,9,0z M9,15.93 c-3.83,0-6.93-3.1-6.93-6.93S5.17,2.07,9,2.07s6.93,3.1,6.93,6.93S12.83,15.93,9,15.93 M12.5,9c0,1.933-1.567,3.5-3.5,3.5S5.5,10.933,5.5,9S7.067,5.5,9,5.5 S12.5,7.067,12.5,9z",
        t = am4core.create("home-chart-04", am4maps.MapChart), a = new am4core.InterfaceColorSet;
    ...
    var o = t.series.push(new am4maps.MapImageSeries), r = o.mapImages.template;
    ...
    i.path = e, i.horizontalCenter = "middle", i.verticalCenter = "middle", i.scale = .7, i.fill = a.getFor("alternativeBackground"), r.propertyFields.latitude = "latitude", r.propertyFields.longitude = "longitude", o.data = [{
        ...
        longitude: -.1262,
        scale: 1
    }, {svgPath: e, title: "Brussels", latitude: 50.8371, longitude: 4.3676, scale: .5}, {
        svgPath: e,
        title: "Prague",
        latitude: 50.0878,
        longitude: 14.4205,
        scale: .5
    }, {svgPath: e, title: "Bratislava", latitude: 48.2116, longitude: 17.1547, scale: .5}, {
        svgPath: e,
        title: "Kiev",
        latitude: 50.4422,
        longitude: 30.5367,
        scale: .5
    }, {svgPath: e, title: "Paris", latitude: 48.8567, longitude: 2.351, scale: .5}, {
        svgPath: e,
        title: "New York",
        latitude: 40.43,
        longitude: -74,
    ...
    s.nonScalingStroke = !0, s.arrow.nonScaling = !0, s.arrow.width = 4, s.arrow.height = 6, s.stroke = a.getFor("alternativeBackground"), s.fill = a.getFor("alternativeBackground"), s.line.strokeOpacity = .4, c.data = [{
        ...
        multiGeoLine: [[{latitude: 51.5002, longitude: -.1262}, {
            latitude: 40.43,
            longitude: -74
        }]]
    }, {
    ...
    }, {multiGeoLine: [[{latitude: 51.5002, longitude: -.1262}, {latitude: 46.948, longitude: 7.4481}]]}]
...
jQuery("#home-chart-06").length && am4core.ready(function () {
    ...
    var o = ["Rai", "Dem", "Caro", "Jac", "Rich", "Ano", "Amd", "Idal", "Joi", "Mar", "Cur", "Shl", "Meg"]
    for (var t = [], a = 100, n = 120, r = 0; r < o.length; r++)
        n = (a += Math.round((Math.random() < .5 ? 1 : -1) * Math.random() * 5)) + Math.round(10 * Math.random()) + 3, t.push({
        category: o[r],
        open: a,
        close: n
    });
...
jQuery("#home-chart-07").length && am4core.ready(function () {
    ...
    e.data = [{country: "Lithuania", litres: 501.9}, {country: "Czech Republic", litres: 301.9}, {
        country: "Ireland",
        litres: 201.1
    }, {country: "Germany", litres: 165.8}, {country: "Australia", litres: 139.9}, {
        country: "The Netherlands",
...
var animationData = {
    v: "5.5.2", fr: 60, ip: 53, op: 125, w: 192, h: 192, nm: "Comp 1", ddd: 0, assets: [], layers: [{
        ddd: 0,
        ind: 1,
        ty: 4,
        ...
        ks: {
            ...
            s: {a: 0, k: [583.333, 583.333, 100], ix: 6}
        },
        ao: 0,
        ef: [{
            ty: 5,
            ...
            ef: [{
                ...
                v: {
                    a: 1,
                    k: [{i: {x: [.667], y: [1]}, o: {x: [.167], y: [.167]}, t: 59, s: [0]}, {
                        i: {x: [.667], y: [1]},
                        o: {x: [.333], y: [0]},
                        t: 70,
                        s: [7]
                    }, {i: {x: [.667], y: [1]}, o: {x: [.333], y: [0]}, t: 75, s: [-4]}, {
                        i: {x: [.667], y: [1]},
                        o: {x: [.333], y: [0]},
                        t: 85,
                        s: [2]
                    }, {i: {x: [.667], y: [1]}, o: {x: [.333], y: [0]}, t: 93, s: [-1]}, {t: 98, s: [0]}],
                    ix: 1
                }
            }, {ty: 3, nm: "Start", mn: "CC Bend It-0002", ix: 2, v: {a: 0, k: [95.5, -19], ix: 2}}, {
                ty: 3,
                nm: "End",
                mn: "CC Bend It-0003",
                ix: 3,
                v: {a: 0, k: [93, 213], ix: 3}
            }, {ty: 7, nm: "Render Prestart", mn: "CC Bend It-0004", ix: 4, v: {a: 0, k: 3, ix: 4}}, {
                ty: 7,
                nm: "Distort",
                mn: "CC Bend It-0005",
                ix: 5,
        ...
        shapes: [{
            ...
            it: [{
                ...
                ks: {
                    a: 0,
                    k: {
                        i: [[0, 0], [.956, .553], [.174, .302]],
                        o: [[-.555, .955], [-.301, -.175], [0, 0]],
                        v: [[1.73, -.64], [-1.004, .087], [-1.73, -.64]],
                        c: !1
                    },
                    ix: 2
                },
                ...
                r: {
                    a: 1,
                    k: [{i: {x: [.833], y: [.833]}, o: {x: [.167], y: [.167]}, t: 59, s: [0]}, {
                        i: {
                            x: [.833],
                            y: [.833]
                        }, o: {x: [.167], y: [.167]}, t: 69, s: [29]
                    }, {i: {x: [.833], y: [.833]}, o: {x: [.167], y: [.167]}, t: 72, s: [11]}, {
                        i: {
                            x: [.833],
                            y: [.833]
                        }, o: {x: [.167], y: [.167]}, t: 73, s: [-4.575]
                    }, {i: {x: [.833], y: [.833]}, o: {x: [.167], y: [.167]}, t: 77, s: [-24]}, {
                        i: {
                            x: [.833],
                            y: [.833]
                        }, o: {x: [.167], y: [.167]}, t: 83, s: [-4]
                    }, {i: {x: [.833], y: [.833]}, o: {x: [.167], y: [.167]}, t: 86, s: [14]}, {
                        i: {
                            x: [.833],
                            y: [.833]
                        }, o: {x: [.167], y: [.167]}, t: 91, s: [10]
                    }, {i: {x: [.833], y: [.833]}, o: {x: [.167], y: [.167]}, t: 95, s: [-5]}, {
                        i: {
                            x: [.833],
                            y: [.833]
                        }, o: {x: [.167], y: [.167]}, t: 99, s: [-5]
                    }, {i: {x: [.833], y: [.833]}, o: {x: [.167], y: [.167]}, t: 103, s: [8]}, {t: 106, s: [2]}],
                    ix: 6
                },
                o: {a: 0, k: 100, ix: 7},
                sk: {a: 0, k: 0, ix: 4},
            ...
            it: [{
                ...
                ks: {
                    a: 0,
                    k: {
                        i: [[0, 7], [4.652, -2.631], [-.03, -1.912], [0, 0], [0, 0]],
                        o: [[0, -4.399], [-1.665, .941], [.114, 7.316], [0, 0], [0, 0]],
                        v: [[6, -.654], [-3.387, -5.715], [-6.003, -1.044], [-9, 8.346], [9, 8.346]],
                        c: !0
                    },
                    ix: 2
                },
                ...
                ty: "tr",
                p: {a: 0, k: [12, 8.654], ix: 2},
                a: {a: 0, k: [0, 0], ix: 1},
                s: {a: 0, k: [100, 100], ix: 3},
                r: {
                    a: 1,
                    k: [{i: {x: [.667], y: [.649]}, o: {x: [.333], y: [0]}, t: 59, s: [0]}, {
                        i: {x: [.667], y: [.534]},
                        o: {x: [.333], y: [.605]},
                        t: 64,
                        s: [16.49]
                    }, {i: {x: [.71], y: [.694]}, o: {x: [.302], y: [-.094]}, t: 69, s: [26.049]}, {
                        i: {
                            x: [.778],
                            y: [1]
                        }, o: {x: [.426], y: [1.157]}, t: 74, s: [-16.741]
                    }, {i: {x: [.667], y: [1]}, o: {x: [.167], y: [0]}, t: 78, s: [-30.021]}, {
                        i: {x: [.667], y: [1]},
                        o: {x: [.167], y: [0]},
                        t: 88,
                        s: [19.021]
                    }, {i: {x: [.79], y: [1]}, o: {x: [.299], y: [0]}, t: 96, s: [-11]}, {
                        i: {x: [.585], y: [.443]},
                        o: {x: [.178], y: [0]},
                        t: 103,
                        s: [9]
                    }, {i: {x: [.667], y: [1]}, o: {x: [.348], y: [1.956]}, t: 107, s: [-2.3]}, {
                        i: {x: [.833], y: [1]},
                        o: {x: [.167], y: [0]},
                        t: 111,
                        s: [-5]
                    }, {i: {x: [.833], y: [1]}, o: {x: [.167], y: [0]}, t: 114, s: [2]}, {t: 118, s: [0]}],
                    ix: 6
                },
                o: {a: 0, k: 100, ix: 7},
                sk: {a: 0, k: 0, ix: 4},
...
var anim;
animationData = {
    v: "5.5.2", fr: 120, ip: 0, op: 150, w: 192, h: 192, nm: "Comp 1", ddd: 0, assets: [], layers: [{
        ddd: 0,
        ind: 1,
        ty: 4,
        ...
        shapes: [{
            ...
            ty: "gr", it: [{
                ...
                ks: {
                    ...
                    k: [{
                        ...
                        s: [{
                            i: [[0, 0], [0, 0], [0, 0], [0, 0]],
                            o: [[0, 0], [0, 0], [0, 0], [0, 0]],
                            v: [[.018, 8.085], [.031, 8.073], [.006, 8.073], [.031, 8.061]],
                            c: !1
                        }]
                    }, {
                        i: {x: .667, y: 1},
                        ...
                        s: [{
                            i: [[0, 0], [0, 0], [0, 0], [0, 0]],
                            o: [[0, 0], [0, 0], [0, 0], [0, 0]],
                            v: [[3.929, 5.275], [3.859, 2.97], [-4.167, 2.966], [-4.131, 5.04]],
                            c: !1
                        }]
                    }, {
                        i: {x: .667, y: 1},
                        ...
                        s: [{
                            i: [[0, 0], [0, 0], [0, 0], [0, 0]],
                            o: [[0, 0], [0, 0], [0, 0], [0, 0]],
                            v: [[7.012, 2.915], [6.928, -8.044], [-7.072, -8.044], [-6.988, 2.915]],
                            c: !1
                        }]
                    }, {
                        i: {x: .667, y: 1},
                        ...
                        s: [{
                            i: [[0, 0], [0, 0], [0, 0], [0, 0]],
                            o: [[0, 0], [0, 0], [0, 0], [0, 0]],
                            v: [[7.012, 2.915], [7.049, -3.207], [-6.951, -3.207], [-6.988, 2.915]],
                            c: !1
                        }]
                    }, {
                        i: {x: .667, y: 1},
                        ...
                        s: [{
                            i: [[0, 0], [0, 0], [0, 0], [0, 0]],
                            o: [[0, 0], [0, 0], [0, 0], [0, 0]],
                            v: [[7.027, 2.479], [7.027, -4.521], [-6.973, -4.521], [-6.973, 2.479]],
                            c: !1
                        }]
                    }, {
                        t: 105,
                        s: [{
                            i: [[0, 0], [0, 0], [0, 0], [0, 0]],
                            o: [[0, 0], [0, 0], [0, 0], [0, 0]],
                            v: [[7.012, 2.915], [7.012, -4.085], [-6.988, -4.085], [-6.988, 2.915]],
                            c: !1
                        }]
                    }],
                    ix: 2
                ...
                sa: {a: 0, k: 0, ix: 5},
                nm: "Transform"
            }], nm: "Group 2", np: 3, cix: 2, bm: 0, ix: 2, mn: "ADBE Vector Group", hd: !1
        }, {
            ty: "gr",
            it: [{
                ind: 0,
                ...
                ks: {
                    a: 0,
                    k: {
                        i: [[-.99, 0], [0, 0], [0, -.907], [0, 0], [.991, 0], [0, 0], [0, .908], [0, 0]],
                        o: [[0, 0], [.991, 0], [0, 0], [0, .908], [0, 0], [-.99, 0], [0, 0], [0, -.907]],
                        v: [[-7.2, -6.6], [7.2, -6.6], [9, -4.95], [9, 4.95], [7.2, 6.6], [-7.2, 6.6], [-9, 4.95], [-9, -4.95]],
                        c: !0
                    },
                    ix: 2
                },
        ...
        ks: {
            ...
            r: {
                a: 1,
                k: [{i: {x: [.667], y: [1]}, o: {x: [.333], y: [0]}, t: 14, s: [0]}, {
                    i: {x: [.667], y: [1]},
                    o: {x: [.333], y: [0]},
                    t: 41,
                    s: [-8]
                }, {i: {x: [.667], y: [1]}, o: {x: [.333], y: [0]}, t: 65, s: [4]}, {
                    i: {x: [.667], y: [1]},
                    o: {x: [.333], y: [0]},
                    t: 90,
                    s: [-2]
        ...
        shapes: [{
                ...
                ks: {
                    ...
                    k: [{
                        ...
                        s: [{
                            i: [[0, 0], [0, 0], [0, 0]],
                            o: [[0, 0], [0, 0], [0, 0]],
                            v: [[7.988, -3.882], [0, -10.24], [-7.988, -3.845]],
                            c: !1
                        }]
                    }],
                    ix: 2
            ...
            it: [{
                ...
                s: {
                    a: 1,
                    k: [{i: {x: [.667], y: [1]}, o: {x: [.333], y: [0]}, t: 30, s: [0]}, {t: 55, s: [26]}],
                    ix: 1
                },
                e: {
                    a: 1,
                    k: [{i: {x: [.667], y: [1]}, o: {x: [.333], y: [0]}, t: 30, s: [100]}, {t: 55, s: [98]}],
                    ix: 2
                },
                o: {a: 0, k: 0, ix: 3},
                m: 1,
...
anim = lottie.loadAnimation(params);
const $tableID = $("#table"), $BTN = $("#export-btn"), $EXPORT = $("#export"),
...
$(".table-add").on("click", "i", () => {
    ...
    i(o), $(".next").click(function () {
        e = $(this).parent(), t = $(this).parent().next(), $("#top-tab-list li").eq($("fieldset").index(t)).addClass("active"), $("#top-tab-list li").eq($("fieldset").index(e)).addClass("done"), t.show(), e.animate({opacity: 0}, {
            step: function (a) {
                n = 1 - a, e.css({display: "none", position: "relative"}), t.css({opacity: n})
            }, duration: 500
        }), i(++o)
    }), $(".previous").click(function () {
        e = $(this).parent(), a = $(this).parent().prev(), $("#top-tab-list li").eq($("fieldset").index(e)).removeClass("active"), $("#top-tab-list li").eq($("fieldset").index(a)).removeClass("done"), a.show(), e.animate({opacity: 0}, {
            step: function (t) {
    ...
    i(o), $(".next").click(function () {
        e = $(this).parent(), t = $(this).parent().next(), $("#top-tabbar-vertical li").eq($("fieldset").index(t)).addClass("active"), t.show(), e.animate({opacity: 0}, {
            step: function (a) {
                n = 1 - a, e.css({display: "none", position: "relative"}), t.css({opacity: n})
            }, duration: 500
        }), i(++o)
    }), $(".previous").click(function () {
        e = $(this).parent(), a = $(this).parent().prev(), $("#top-tabbar-vertical li").eq($("fieldset").index(e)).removeClass("active"), a.show(), e.animate({opacity: 0}, {
            step: function (t) {
                n = 1 - t, e.css({display: "none", position: "relative"}), a.css({opacity: n})
            }, duration: 500
        }), i(--o)
    ...
    $(".progress-round").each(function () {
        var t = $(this).attr("data-value"), a = $(this).find(".progress-left .progress-bar"),
